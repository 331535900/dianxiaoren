...
<div class="container" style="margin-top: 23px;">
	<div class="left">
		...
		<a href="">
		<img src="http://www.dianxiaoren.cc/dian1.png" width="100%" height="70%"/>
		</a>
    ...
    <div class="middle text">
        <h4 class="title">
            ...
            <?php endif ?>
			<a style="<?php if ($v['top']==2): ?>font-weight: bold;color: #09C;<?php elseif ($v['top']==1): ?>font-weight: bold;color: #CE792D;<?php endif ?>" class="thread-title" href="<?php HYBBS_URL('thread',$v['tid']); ?>"><?php if ($v['top']==2): ?><span class="qzd"><?php echo $_LANG['全站置顶'];?></span><?php elseif ($v['top']==1): ?><span class="fzd"><?php echo $_LANG['本版置顶'];?></span><?php endif ?><?php echo $v['title'];?><?php if ($v['digest']): ?><i class="iconfont icon-jinghua" title="<?php echo $_LANG['精'];?>" style="color: tomato;margin-left: 5px"></i><?php endif ?><?php if ($v['state']): ?><i class="iconfont icon-lock" style="margin-left: 5px;color: grey"></i><?php endif ?></a>
