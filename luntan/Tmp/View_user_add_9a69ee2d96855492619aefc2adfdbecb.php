...
<div>
    <form id="user-add-form" method="post" onsubmit="return user_add()">
	   <div class="hy-box" style="margin-top:20px">
		    ...
		    <div class="hy-input-box">
		        <input type="text" name="email" placeholder="<?php echo $_LANG['请输入安全邮箱'];?>">
		    </div>
		    
		    <div class="hy-input-box">
		        <input type="password" name="pass1" placeholder="<?php echo $_LANG['请输入密码'];?>">
		    </div>
    	...
    	<div style="padding:10px;    text-align: center;">
    		<button type="submit" class="id-add hy-btn hy-btn-danger hy-btn-block" style="padding: 8px 0;"><?php echo $_LANG['注册'];?></button>
...
function user_add(){
    ...
    $.ajax({
        ...
        success:function(e){
            ...
            $(".id-add").removeAttr('disabled').text('<?php echo $_LANG['注册'];?>');
            if(e.error){
                if(e.url !='')
