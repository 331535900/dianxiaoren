...
<div class="dashboard-header">
    <p class="sub-title"><?php echo $_LANG['您已发布'];?>
        <span><?php echo $data['threads'];?></span><?php echo $_LANG['篇文章作品'];?><a href="<?php HYBBS_URL('post') ?>"><span class="new-post-btn"><?php echo $_LANG['写文章'];?></span></a></p>
</div>
...
<div class="dashboard-wrapper select-posts">
	<article class="panel panel-default archive" role="main">
        ...
        <div class="pagination">
            ...
            <span class="pg-item ">
                <<?php if ($pageid == $i): ?>span<?php else: ?>a<?php endif ?> class="page-numbers <?php if ($pageid == $i): ?>current<?php endif ?>" href="<?php HYBBS_URL('my',$data['user'],['thread'=>$i]); ?>">
                    <?php echo $i;?>
            ...
            <span class="pg-item" <?php if ($pageid==1): ?>disabled<?php endif ?>>
                <a class="next page-numbers" href="<?php HYBBS_URL('my',$data['user'],['thread'=>$pageid+1]); ?>"><?php echo $_LANG['下一页'];?></a>
            </span>
            <?php endif ?>
    	</div>
