...
<?php //Hook ##START##a:3:{s:11:"plugin_name";s:19:"HY-MEditor编辑器";s:8:"dir_name";s:10:"hy_meditor";s:4:"path";s:56:"/www/wwwroot/luntan/Plugin/hy_meditor/t_m_post_edit.hook";}## ?>
...
<div class="editor-box" style="padding:10px;">
    ...
    <input type="text" id="title" class="editor-text " placeholder="请填写标题" value="<?php echo $thread_data['title'];?>">
</div>
...
<div class="editor-box" style="padding:10px;">
    ...
    <input type="text" class="editor-text" id="tgold" style="width:100px" placeholder="金币数量" value="<?php echo $thread_data['gold'];?>">
</div>
...
<div class="editor-box" id="file-box" style="padding:10px;display:block">
    ...
    <div id="file_rq">
        ...
        <table>
            <tr>
                <th>ID</th>
                <td class="fileid"><?php echo $v['fileid'];?></td>
            </tr>
            <tr>
                <th>附件名称</th>
            ...
            <tr>
                <th>付费金币</th>
                <td><input type="number" class="filegold" value="<?php echo $v['gold'];?>"></td>
            </tr>
            <tr>
                <th>隐藏附件</th>
                <td><input class="hy-switch hy-switch-anim filehide" type="checkbox" <?php if ($v['hide']): ?>checked<?php endif ?>>
                </td>
            </tr>
            <tr>
                <th>附件描述</th>
                <td><input type="text" class="filemess" value="<?php echo $v['mess'];?>" ></td>
            </tr>
            <tr>
                <th>操作</th>
...
<?php //Hook ##END##a:3:{s:11:"plugin_name";s:19:"HY-MEditor编辑器";s:8:"dir_name";s:10:"hy_meditor";s:4:"path";s:56:"/www/wwwroot/luntan/Plugin/hy_meditor/t_m_post_edit.hook";}## ?>
