					...
					<div class="smart-widget-body">
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="user">
								<div class="form-group">
									<label class="col-lg-2 control-label">开启用户修改用户名</label>
									<div class="col-lg-10">
										<div class="checkbox inline-block">
											<div class="custom-checkbox">
												<input type="checkbox" name="on_edit_user" id="on-edit-user" class="checkbox-red" <?php if ($conf['on_edit_user']): ?>checked="checked"<?php endif ?>>
												<label for="on-edit-user"></label>
											</div>
							...
							<div class="tab-pane fade" id="style2Tab5">
								...
								<div class="form-group">
									<label class="col-lg-2 control-label">主题加精增加金钱</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="credits_thread" value="<?php echo $conf['gold_digest'];?>">
										<span class="help-block">取消加精会扣除</span>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-2 control-label">主题加精增加积分</label>
									<div class="col-lg-10">
										<input class="form-control" type="text" name="credits_post" value="<?php echo $conf['credits_digest'];?>">
										<span class="help-block">同上</span>
									</div>
								</div>
