		...
		<div class="wrap-box t-info">
			<div class="head">
		        <h1>
		        	...
		        	<?php if ($thread_data['digest']): ?><i class="iconfont icon-jinghua" title="<?php echo $_LANG['精'];?>" style="color: tomato;    font-size: inherit;"></i><?php endif ?>
		        	<?php if ($thread_data['state']): ?><i class="iconfont icon-lock" title="<?php echo $_LANG['禁止回复'];?>" style="color: grey;    font-size: inherit;"></i><?php endif ?>
		        </h1>
		        <div class="meta">
		      ...
		      <div class="actions">
				...
				<?php if (IS_LOGIN): ?>
		            ...
		            <i class="iconfont icon-<?php if ($thread_data['state']): ?>un<?php endif ?>lock"></i> <?php if ($thread_data['state']): ?><?php echo $_LANG['解锁帖子'];?><?php else: ?><?php echo $_LANG['锁定帖子'];?><?php endif ?>
		            </a>
		            <?php endif ?>

		            <a href="javascript:;" class="btn btn-link" onclick="star(<?php echo $thread_data['tid'];?>,this)">
		            <i class="iconfont icon-star" ></i> <?php if ($thread_data['star']): ?>取消<?php endif ?>收藏
		            </a>
				<?php endif ?>
			...
			<div style="border-top: 1px solid #F3F3F3;margin-top: 15px;padding-top: 10px;">
		            ...
		            <?php endif ?>
                      ...
                      <a href="javascript:void(0);" class="btn btn-info is-active" onclick="thread_digest(<?php echo $thread_data['tid'];?>,0)" >
                          <i class="iconfont icon-jinghua"></i> <?php echo $_LANG['取消加精'];?>
                      </a>
                      <?php else: ?>
                      <a href="javascript:void(0);" class="btn btn-link" onclick="thread_digest(<?php echo $thread_data['tid'];?>,1)" >
                          <i class="iconfont icon-jinghua"></i> <?php echo $_LANG['加精'];?>
                      </a>
                      <?php endif ?>
                      <?php endif ?>
	        ...
	        <div class="item" id="post-<?php echo $v['pid'];?>">
				...
				<div class="r">
		            ...
		            <div class="text typo editor-style">
		            	...
		            	<?php if ($v['rpid'] && !empty($quote_data)): ?>
...
<?php //Hook ##START##a:3:{s:11:"plugin_name";s:18:"HY-Editor编辑器";s:8:"dir_name";s:9:"hy_editor";s:4:"path";s:63:"/www/wwwroot/luntan/luntan/Plugin/hy_editor/t_thread_index.hook";}## ?>
...
<?php //Hook ##END##a:3:{s:11:"plugin_name";s:18:"HY-Editor编辑器";s:8:"dir_name";s:9:"hy_editor";s:4:"path";s:63:"/www/wwwroot/luntan/luntan/Plugin/hy_editor/t_thread_index.hook";}## ?>
